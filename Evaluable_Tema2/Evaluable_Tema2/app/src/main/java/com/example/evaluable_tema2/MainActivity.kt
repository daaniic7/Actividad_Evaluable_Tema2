...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var btn_chistes: ImageView
    private lateinit var btn_dados: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_chistes = findViewById(R.id.id_btn_chistes)
        btn_dados = findViewById(R.id.id_btn_dados)
        ...
        // Pulsando este botón se nos activará automáticamente una alarma que sonará
        ...
        // Al pulsar este botón serás redirigido a un video específico de YouTube
        ...
        // Botón para ir al Activity de Chistes
        btn_chistes.setOnClickListener {
            intent = Intent(this, ChistesActivity::class.java)
            startActivity(intent)
        }

        // Botón para ir al Activity de Dados
        btn_dados.setOnClickListener {
            intent = Intent(this, DadosActivity::class.java)
            startActivity(intent)
        }
    }
